...
if tonumber(user_id) == tonumber(157107537) then
var = 'مطور السورس 👨🏻‍🔧'  
elseif tonumber(user_id) == tonumber(SUDO) then
var = 'االمطور الاساسي 👨🏻‍💻'  
...
local FRIENDS_Msg = ''  
if msgs < 100 then 
FRIENDS_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
FRIENDS_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
FRIENDS_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
FRIENDS_Msg = 'متفاعل' 
elseif msgs < 1200 then 
FRIENDS_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
FRIENDS_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
FRIENDS_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
FRIENDS_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
FRIENDS_Msg = 'قمة التفاعل' 
elseif msgs < 5500 then 
FRIENDS_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
FRIENDS_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
FRIENDS_Msg = 'امبروطور التفاعل☣️' 
elseif msgs < 10000000000 then 
FRIENDS_Msg = 'رب التفاعل💖'  
end 
return FRIENDS_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceFRIENDS(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,FRIENDS_Msg) 
return false  
end 
if text then    
...
send(msg.chat_id_, msg.id_,'📌¦ عدد المجموعات الان » { '..#group..' }'..FRIENDSk..''..FRIENDS..'\n*📌┇ الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
usertext = '\n👤¦ العضو » ['..result.title_..'](t.me/'..(username or 'DEVFRIENDS')..')'
...
usertext = '\n👤¦ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVFRIENDS')..')'
status  = '\n📫¦ تم ترقيته مطور في البوت'
...
local FRIENDS_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if FRIENDS_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠¦العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n📛¦["..FRIENDS_Msg.."] \n") 
else
send(msg.chat_id_,0,"⚠¦العضو : {["..data.first_name_.."](T.ME/DEVFRIENDS)}\n📛¦["..FRIENDS_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "⚠┇عذرا يا » {["..data.first_name_.."](T.ME/DEVFRIENDS)}\n📛┇ الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
Text = [[
📮¦ Welcome to private source 𝗙𝗥𝗜𝗘𝗡𝗗𝗦
┄─━━☆~~~~~~☆━━─┄
🔰¦ ➥ CH》[soruce](t.me/O0_O4)

🔱¦ ➥ [Tawsl](t.me/K_1_Abot)

📍¦ ➥ [dev soruce](t.me/K_4_A)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'👤¦ بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'DEVFRIENDS')..') \n🔐¦ تـم قفـل الدردشه ')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤¦ بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'DEVFRIENDS')..') \n🔐¦ تـم قفـل التاك بالكتم ')  
end,nil)   
...
local UserName = (b.username_ or "FRIENDS")
...
usertext = '\n👤¦ المستخدم » ['..result.title_..'](t.me/'..(username or 'DEVFRIENDS')..')'
statusk  = '\n📫¦ تم طرده من هنا'
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
 usertext = '\n👤¦ المستخدم » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVFRIENDS')..')'
 statusk  = '\n📫¦ تم طرده من هنا'
send(msg.chat_id_, msg.id_, usertext..statusk)
else
 usertext = '\n👤¦ المستخدم » '..userid..''
...
time = times * 60
local function Restricted(Kara,FRIENDS)
if tonumber(FRIENDS.sender_user_id_) == tonumber(bot_id) then
send(msg.chat_id_, msg.id_, '\n⚠¦ عذرا لا تستطيع كتم ( '..Rutba(FRIENDS.sender_user_id_,msg.chat_id_)..' )')
return false  
end
if Can_or_NotCan(FRIENDS.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n⚠¦ عذرا لا تستطيع كتم ( '..Rutba(FRIENDS.sender_user_id_,msg.chat_id_)..' )')
else
MuteUser(msg.chat_id_,FRIENDS.sender_user_id_,msg.date_+time)
local function name(kara,FRIENDS)
if FRIENDS.username_ == '' then name = FRIENDS.first_name_ else name = FRIENDS.username_ end
send(msg.chat_id_,msg.id_,"⚠ ¦ العضو《["..name.."](tg://user?id="..FRIENDS.sender_user_id_..")》\nا┄─━━◉━━─┄\n⏳¦ تم كتم لمدة "..times.." دقايق ⏰")
end
getUser(FRIENDS.sender_user_id_,name)
end
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else
...
t = "\n📌¦ قائمة المنع \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do  
local FRIENDS_Msg = database:get(bot_id.."Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..''..k..'- '..v..' » {'..FRIENDS_Msg..'}\n'    
end  
if #list == 0 then  
...
if blakrt == 'مميز 🕵🏻‍♀️' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n👤¦ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'DEVFRIENDS')..')'..'\n📬¦ تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,'['..FRIENDS_Msg[math.random(#FRIENDS_Msg)]..']') 
return false
end
...
FRIENDS = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(FRIENDS)
...
--------------------------------------------------------------------------------------------------------------
SourceFRIENDS(data.message_,data)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
------------------------------------------------------------------------
local FRIENDSbot = database:get(bot_id.."Add:Filter:Rp2"..text..result.chat_id_)   
if FRIENDSbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠¦العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n📛¦["..FRIENDSbot.."] \n") 
